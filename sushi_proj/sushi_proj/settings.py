"""
Django settings for sushi_proj project.
...
SECRET_KEY = '-f32kw3re+pq9)!=gct37eg1kl@e^nd)yt!gq)0fc7oz*almxr'
...
WSGI_APPLICATION = 'sushi_proj.wsgi.application'
